...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 shrink-0 bg-white border-r border-[#E2E8F0] flex flex-col transform -translate-x-full transition-transform duration-300 md:static md:translate-x-0 md:z-auto w-64 bg-white border-r border-gray-200 h-full">
    ...
    <nav class="flex-1 px-4 py-2 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('team-members.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('team-members.index') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm {{ request()->routeIs('team-members.index') ? 'font-semibold' : 'font-medium' }}">Team Members</span>
        </a>
        ...
        <a href="{{ route('settings.locations.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('settings.locations.*') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            ...
            <span class="text-sm {{ request()->routeIs('settings.locations.*') ? 'font-semibold' : 'font-medium' }}">Locations</span>
        </a>
