...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 flex h-full w-64 shrink-0 -translate-x-full flex-col border-r border-zinc-800 bg-zinc-900 text-zinc-300 shadow-2xl shadow-black/30 transition-transform duration-300 ease-out md:static md:z-auto md:translate-x-0 md:shadow-none">
    ...
    <nav id="adminNav" class="flex-1 space-y-0.5 overflow-y-auto px-3 py-2">
        <a href="{{ route('admin-dashboard') }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors duration-150 {{ $isAdminDashboard ? 'bg-white/10 text-white shadow-sm shadow-black/20' : 'text-zinc-400 hover:bg-white/[0.06] hover:text-zinc-100' }}">
        ...
        <a href="{{ route('admin-tenant') }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors duration-150 {{ $isAdminTenant ? 'bg-white/10 text-white shadow-sm shadow-black/20' : 'text-zinc-400 hover:bg-white/[0.06] hover:text-zinc-100' }}">
        ...
        <a href="{{ route('admin-products') }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors duration-150 {{ $isAdminProducts ? 'bg-white/10 text-white shadow-sm shadow-black/20' : 'text-zinc-400 hover:bg-white/[0.06] hover:text-zinc-100' }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="{{ route('admin-users') }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors duration-150 {{ $isAdminUsers ? 'bg-white/10 text-white shadow-sm shadow-black/20' : 'text-zinc-400 hover:bg-white/[0.06] hover:text-zinc-100' }}">
        ...
        <a href="{{ route('admin-infrastructure') }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors duration-150 {{ $isAdminInfrastructure ? 'bg-white/10 text-white shadow-sm shadow-black/20' : 'text-zinc-400 hover:bg-white/[0.06] hover:text-zinc-100' }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="{{ route('admin-billing') }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors duration-150 {{ $isAdminBilling ? 'bg-white/10 text-white shadow-sm shadow-black/20' : 'text-zinc-400 hover:bg-white/[0.06] hover:text-zinc-100' }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="border-t border-zinc-800 p-4 space-y-2">
        <a href="{{ route('admin-profile') }}" class="flex items-center gap-3 rounded-xl p-2 transition-colors {{ $isAdminProfile ? 'bg-white/10' : 'hover:bg-white/[0.06]' }}">
            <div class="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-zinc-700">
            ...
            <div class="min-w-0">
                <div class="truncate text-sm font-semibold text-white">Admin Profile</div>
