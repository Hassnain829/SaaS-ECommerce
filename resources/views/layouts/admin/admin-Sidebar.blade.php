...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 shrink-0 bg-white border-r border-[#E2E8F0] flex flex-col transform -translate-x-full transition-transform duration-300 md:static md:translate-x-0 md:z-auto w-64 bg-white border-r border-gray-200 h-full">
    ...
    <nav class="flex-1 px-4 py-2 space-y-1 overflow-y-auto">
        <a href="{{ route('admin-dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin-dashboard') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 6V0H18V6H10ZM0 10V0H8V10H0ZM10 18V8H18V18H10ZM0 18V12H8V18H0Z" fill="currentColor"/>
            </svg>
            <span class="text-sm {{ request()->routeIs('admin-dashboard') ? 'font-semibold' : 'font-medium' }}">Dashboard</span>
        </a>

        <a href="{{ route('admin-tenant') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.tenants') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            ...
            <span class="text-sm {{ request()->routeIs('admin.tenants') ? 'font-semibold' : 'font-medium' }}">Tenants</span>
        </a>

        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.products') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm {{ request()->routeIs('admin.products') ? 'font-semibold' : 'font-medium' }}">Products</span>
        </a>

        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.users') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            ...
            <span class="text-sm {{ request()->routeIs('admin.users') ? 'font-semibold' : 'font-medium' }}">Users</span>
        </a>

        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.infrastructure') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm {{ request()->routeIs('admin.infrastructure') ? 'font-semibold' : 'font-medium' }}">Infrastructure</span>
        </a>

        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.billing') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm {{ request()->routeIs('admin.billing') ? 'font-semibold' : 'font-medium' }}">Billing</span>
        </a>

        <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.settings') ? 'bg-[#0052CC]/10 text-[#0052CC]' : 'text-[#475569] hover:bg-gray-50' }}">
            ...
            <span class="text-sm {{ request()->routeIs('admin.settings') ? 'font-semibold' : 'font-medium' }}">Settings</span>
        </a>
    </nav>
    ...
    <div class="border-t border-gray-200 p-4">
        <a href="{{ route('profileSettings') }}" class="flex items-center gap-3 rounded-xl p-2 transition-colors {{ request()->routeIs('profileSettings') ? 'bg-[#0052CC]/10' : 'hover:bg-[#0052CC]/5' }}">
            ...
            <div class="min-w-0">
                <div class="text-sm font-semibold text-[#0F172A] truncate">Admin User</div>
                <div class="text-xs {{ request()->routeIs('profileSettings') ? 'text-[#0052CC]' : 'text-[#64748B]' }}">Administrator</div>
            </div>
        </a>
    </div>
</aside>
