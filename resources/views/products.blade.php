...
<header class="sticky top-0 z-30 bg-white border-b border-gray-200 px-4 lg:px-6 py-3 flex items-center justify-between gap-3 shrink-0">
    ...
    <div class="relative flex-1 max-w-xs sm:max-w-sm md:max-w-md">
        ...
        <input type="text" placeholder="Search products, SKUs, categories..." class="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg py-2 pl-10 pr-4 text-sm text-[#0F172A] placeholder:text-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#0052CC]/20">
    </div>
...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        ...
        <!-- Mobile add btn -->
        <button class="sm:hidden flex items-center justify-center gap-2 bg-[#0052CC] text-white text-sm font-bold px-4 py-2.5 rounded-lg">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M5 6.66667H0V5H5V0H6.66667V5H11.6667V6.66667H6.66667V11.6667H5V6.66667Z" fill="white"/></svg>
            Add Product
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl border border-[#E2E8F0] p-5 shadow-sm">
                <div class="flex justify-between items-start">
                    <div class="w-10 h-10 bg-[#0052CC]/10 rounded-lg flex items-center justify-center">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M3 20C2.45 20 1.97917 19.8042 1.5875 19.4125C1.19583 19.0208 1 18.55 1 18V6.725C0.7 6.54167 0.458333 6.30417 0.275 6.0125C0.0916667 5.72083 0 5.38333 0 5V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H18C18.55 0 19.0208 0.195833 19.4125 0.5875C19.8042 0.979167 20 1.45 20 2V5C20 5.38333 19.9083 5.72083 19.725 6.0125C19.5417 6.30417 19.3 6.54167 19 6.725V18C19 18.55 18.8042 19.0208 18.4125 19.4125C18.0208 19.8042 17.55 20 17 20H3ZM3 7V18H17V7H3ZM2 5H18V2H2V5ZM7 12H13V10H7V12Z" fill="#0052CC"/></svg>
                    </div>
                    <span class="bg-green-50 text-green-600 text-xs font-semibold px-2 py-1 rounded-full flex items-center gap-1">
                        <svg width="10" height="7" viewBox="0 0 12 8" fill="none"><path d="M0.933333 8L0 7.06667L4.93333 2.1L7.6 4.76667L11.0667 1.33333H9.33333V0H13.3333V4H12V2.26667L7.6 6.66667L4.93333 4L0.933333 8Z" fill="#059669"/></svg>
                        12.5%
                    </span>
                </div>
                <div class="mt-3">
            ...
            <div class="bg-white rounded-xl border border-[#E2E8F0] p-5 shadow-sm">
                <div class="flex justify-between items-start">
                    <div class="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M9 13H11V15H9V13ZM9 5H11V11H9V5ZM10 0C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 10 0ZM10 18C5.59 18 2 14.41 2 10C2 5.59 5.59 2 10 2C14.41 2 18 5.59 18 10C18 14.41 14.41 18 10 18Z" fill="#EF4444"/></svg>
                    </div>
            ...
            <div class="bg-white rounded-xl border border-[#E2E8F0] p-5 shadow-sm">
                <div class="flex justify-between items-start">
                    <div class="w-10 h-10 bg-orange-50 rounded-lg flex items-center justify-center">
                        <svg width="4" height="20" viewBox="0 0 4 20" fill="none"><rect width="4" height="20" rx="2" fill="#F97316"/></svg>
                    </div>
            ...
            <div class="bg-[#0052CC]/5 rounded-xl border border-[#0052CC]/20 p-5 shadow-sm">
                <div class="flex justify-between items-start">
                    <div class="w-10 h-10 bg-[#0052CC]/10 rounded-lg flex items-center justify-center">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M4 14H6V9H4V14ZM12 14H14V4H12V14ZM8 14H10V11H8V14ZM8 9H10V7H8V9ZM2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H16C16.55 0 17.0208 0.195833 17.4125 0.5875C17.8042 0.979167 18 1.45 18 2V16C18 16.55 17.8042 17.0208 17.4125 17.4125C17.0208 17.8042 16.55 18 16 18H2Z" fill="#0052CC"/></svg>
                    </div>
    ...
    <div class="bg-white rounded-xl border border-[#E2E8F0] shadow-sm overflow-hidden">
            ...
            <div class="flex flex-wrap items-center gap-2 px-4 lg:px-5 py-4 border-b border-[#E2E8F0]">
                <button class="flex items-center gap-1.5 bg-[#0052CC] text-white text-sm font-semibold px-4 py-2 rounded-full">
                    All Categories
                    <svg width="12" height="12" viewBox="0 0 14 14" fill="none"><path d="M7 9L3 5H11L7 9Z" fill="white"/></svg>
                </button>
                <button class="flex items-center gap-1.5 border border-[#E2E8F0] text-[#475569] text-sm font-medium px-4 py-2 rounded-full hover:bg-gray-50 transition-colors">
                    Low Stock
                    <span class="bg-[#F97316] text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center">12</span>
                </button>
                <button class="border border-[#E2E8F0] text-[#475569] text-sm font-medium px-4 py-2 rounded-full hover:bg-gray-50 transition-colors">Published</button>
                <button class="border border-[#E2E8F0] text-[#475569] text-sm font-medium px-4 py-2 rounded-full hover:bg-gray-50 transition-colors">Drafts</button>
                <div class="ml-auto flex gap-2">
                    <button class="w-9 h-9 flex items-center justify-center border border-[#E2E8F0] rounded-lg hover:bg-gray-50">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M7 11H9V9H7V11ZM1 3V5H15V3H1ZM4 8H12V6H4V8Z" fill="#475569"/></svg>
                    </button>
                    <button class="w-9 h-9 flex items-center justify-center border border-[#E2E8F0] rounded-lg hover:bg-gray-50">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 14H14V12H2V14ZM14 6H11V2H5V6H2L8 12L14 6Z" fill="#475569"/></svg>
                    </button>
                </div>
            </div>
                ...
                <table class="w-full min-w-[700px]">
                    <thead>
                        <tr class="border-b border-[#E2E8F0] bg-[#F8FAFC]">
                            <th class="w-10 px-4 py-3"><input type="checkbox" class="w-4 h-4 rounded border-[#CBD5E1] accent-[#0052CC]"></th>
                    ...
                    <tbody class="divide-y divide-[#F1F5F9]">
                        ...
                        <tr class="hover:bg-[#F8FAFC] transition-colors">
                            <td class="px-4 py-4"><input type="checkbox" class="w-4 h-4 rounded border-[#CBD5E1] accent-[#0052CC]"></td>
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-[#FDDCB5] shrink-0 flex items-center justify-center">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H16C16.55 0 17.0208 0.195833 17.4125 0.5875C17.8042 0.979167 18 1.45 18 2V16C18 16.55 17.8042 17.0208 17.4125 17.4125C17.0208 17.8042 16.55 18 16 18H2Z" fill="#F4A261"/></svg>
                                    </div>
                                    <div>
                            ...
                            <td class="px-4 py-4"><span class="bg-[#F1F5F9] text-[#475569] px-2 py-1 rounded text-xs">Electronics</span></td>
                            <td class="px-4 py-4">
                                <span class="inline-flex items-center gap-1.5 bg-green-50 text-green-600 text-xs font-bold px-3 py-1 rounded-full">
                            ...
                            <td class="px-4 py-4 w-28">
                                <div class="bg-[#F1F5F9] rounded-full h-1.5 min-w-20 overflow-hidden"><div class="h-full rounded-full bg-[#3B82F6]" style="width:85%"></div></div>
                            </td>
                        ...
                        <tr class="hover:bg-[#F8FAFC] transition-colors">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-[#F5D49A] shrink-0 flex items-center justify-center">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H16C16.55 0 17.0208 0.195833 17.4125 0.5875C17.8042 0.979167 18 1.45 18 2V16C18 16.55 17.8042 17.0208 17.4125 17.4125C17.0208 17.8042 16.55 18 16 18H2Z" fill="#E8B86D"/></svg>
                                    </div>
                                    <div>
                            ...
                            <td class="px-4 py-4"><span class="bg-[#F1F5F9] text-[#475569] px-2 py-1 rounded text-xs">Accessories</span></td>
                            <td class="px-4 py-4">
                                <span class="inline-flex items-center gap-1.5 bg-orange-50 text-orange-500 text-xs font-bold px-3 py-1 rounded-full border border-orange-100">
                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none"><circle cx="4" cy="4" r="4" fill="#F97316"/></svg>
                                    Low Stock
                                </span>
                            </td>
                            <td class="px-4 py-4 font-medium text-[#0F172A] text-sm">$59.00</td>
                            <td class="px-4 py-4 w-28">
                                <div class="bg-[#F1F5F9] rounded-full h-1.5 min-w-20 overflow-hidden"><div class="h-full rounded-full bg-[#F97316]" style="width:12%"></div></div>
                            </td>
                        ...
                        <tr class="hover:bg-[#F8FAFC] transition-colors">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-[#E8E0CC] shrink-0 flex items-center justify-center">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H16C16.55 0 17.0208 0.195833 17.4125 0.5875C17.8042 0.979167 18 1.45 18 2V16C18 16.55 17.8042 17.0208 17.4125 17.4125C17.0208 17.8042 16.55 18 16 18H2Z" fill="#C8B89A"/></svg>
                                    </div>
                                    <div>
                            ...
                            <td class="px-4 py-4"><span class="bg-[#F1F5F9] text-[#475569] px-2 py-1 rounded text-xs">Apparel</span></td>
                            <td class="px-4 py-4">
                                <span class="inline-flex items-center gap-1.5 bg-red-50 text-red-600 text-xs font-bold px-3 py-1 rounded-full">
                                    <svg width="8" height="8" viewBox="0 0 8 8" fill="none"><circle cx="4" cy="4" r="4" fill="#EF4444"/></svg>
                                    Out of Stock
                                </span>
                            </td>
                            <td class="px-4 py-4 font-medium text-[#0F172A] text-sm">$25.00</td>
                            <td class="px-4 py-4 w-28">
                                <div class="bg-[#F1F5F9] rounded-full h-1.5 min-w-20 overflow-hidden"><div class="h-full rounded-full bg-[#E2E8F0]" style="width:2%"></div></div>
                            </td>
                        ...
                        <tr class="hover:bg-[#F8FAFC] transition-colors">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-[#FDBA74] shrink-0 flex items-center justify-center">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H16C16.55 0 17.0208 0.195833 17.4125 0.5875C17.8042 0.979167 18 1.45 18 2V16C18 16.55 17.8042 17.0208 17.4125 17.4125C17.0208 17.8042 16.55 18 16 18H2Z" fill="#F97316"/></svg>
                                    </div>
                                    <div>
                            ...
                            <td class="px-4 py-4 w-28">
                                <div class="bg-[#F1F5F9] rounded-full h-1.5 min-w-20 overflow-hidden"><div class="h-full rounded-full bg-[#3B82F6]" style="width:42%"></div></div>
                            </td>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4 lg:px-5 py-4 border-t border-[#E2E8F0]">
                <span class="text-[#64748B] text-sm">Showing <span class="font-semibold text-[#0F172A]">1 to 4</span> of <span class="font-semibold text-[#0F172A]">120</span> results</span>
                <div class="flex items-center gap-1.5">
                    <button class="px-3 py-1.5 text-sm font-medium text-[#475569] border border-[#E2E8F0] rounded-lg hover:bg-gray-50 transition-colors">Previous</button>
                    <button class="w-8 h-8 flex items-center justify-center text-sm font-bold bg-[#0052CC] text-white rounded-lg">1</button>
                    <button class="w-8 h-8 flex items-center justify-center text-sm font-medium text-[#475569] border border-[#E2E8F0] rounded-lg hover:bg-gray-50">2</button>
                    <button class="w-8 h-8 flex items-center justify-center text-sm font-medium text-[#475569] border border-[#E2E8F0] rounded-lg hover:bg-gray-50">3</button>
                    <span class="text-[#94A3B8] text-sm px-0.5">...</span>
                    <button class="w-8 h-8 flex items-center justify-center text-sm font-medium text-[#475569] border border-[#E2E8F0] rounded-lg hover:bg-gray-50">30</button>
                    <button class="px-3 py-1.5 text-sm font-medium text-[#475569] border border-[#E2E8F0] rounded-lg hover:bg-gray-50 transition-colors">Next</button>
                </div>
            </div>
