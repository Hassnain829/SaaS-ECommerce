        ...
        @if ($showNotifications)
            ...
            >
                ...
                @if (! empty($merchantUnreadNotificationCount) && (int) $merchantUnreadNotificationCount > 0)
                    <span class="absolute right-1 top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-[#DC2626] px-1 text-[10px] font-bold leading-none text-white" aria-hidden="true">
