...
<div class="font-inter max-w-9l mx-auto space-y-6 md:space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.05)] border border-[#C3C6D6]/10 p-6 relative">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-lg font-medium text-[#0B1C30]">API Credentials</h2>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.05)] border border-[#C3C6D6]/10 p-6 relative">
                <div class="absolute left-0 top-1 bottom-1 w-1 bg-brand rounded-l"></div>
                <div class="flex items-center gap-2 mb-6">
                    ...
                    <h2 class="text-lg font-medium text-[#0B1C30]">Shipping Logic & Automation</h2>
                </div>
                <div class="space-y-3">
                    <!-- Rule 1 -->
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-[#EFF4FF] rounded-2xl shadow-sm border border-[#C3C6D6]/10 p-6">
                <h3 class="text-sm font-medium uppercase tracking-wider text-[#0B1C30] pb-4 border-b border-[#C3C6D6]/20 mb-4">Supported Services</h3>
                <div class="space-y-3">
                    <!-- Checked items -->
            ...
            <div class="bg-white rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.05)] border border-[#C3C6D6]/10 p-6">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <h3 class="text-sm font-medium text-[#0B1C30]">Webhooks</h3>
                </div>
            ...
            <div class="bg-[#003D9B] rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <h3 class="text-base font-medium">Need Assistance?</h3>
                    </div>
