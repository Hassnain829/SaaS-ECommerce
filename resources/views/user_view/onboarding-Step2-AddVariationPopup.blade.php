    ...
    <div class="fixed inset-0 bg-[#0F172A]/60 backdrop-blur-[2px] flex items-center justify-center p-4 z-50">
        ...
        <div class="w-full max-w-[512px] bg-white rounded-xl shadow-2xl border border-[#E2E8F0] overflow-hidden">
            ...
            <div class="flex justify-between items-center px-6 py-4 border-b border-[#F1F5F9]">
                ...
                <a href="{{ route('onboarding-Step2-AddProductVariations') }}" class="text-[#94A3B8] hover:text-[#64748B]">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <!-- category dropdown -->
                    <div>
                        <label class="block text-sm font-semibold text-[#334155] mb-2">Category</label>
                        <div class="relative">
                            <select class="w-full appearance-none border border-[#E2E8F0] rounded-lg px-4 py-2.5 text-sm text-[#0F172A] bg-white focus:outline-none focus:ring-2 focus:ring-[#0052CC]/20">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="e.g., Fabric" value="Fabric"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="bg-[#F8FAFC] border border-[#F1F5F9] rounded-lg p-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Size</button>
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Color</button>
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Material</button>
                            </div>
                        </div>
                        ...
                        <div class="bg-[#F8FAFC] border border-[#F1F5F9] rounded-lg p-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">License Type</button>
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Resolution</button>
                            </div>
                        </div>
                        ...
                        <div class="bg-[#F8FAFC] border border-[#F1F5F9] rounded-lg p-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Add-ons</button>
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Dietary</button>
                            </div>
                        </div>
                        ...
                        <div class="bg-[#F8FAFC] border border-[#F1F5F9] rounded-lg p-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Tier</button>
                                <button class="bg-white border border-[#E2E8F0] rounded-md px-3 py-1.5 text-xs font-medium text-[#475569] shadow-sm">Billing Interval</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-[#F8FAFC] border-t border-[#F1F5F9] px-6 py-4 flex justify-end items-center gap-3">
                <a href="{{ route('onboarding-Step2-AddProductVariations') }}" class="px-4 py-2 text-sm font-semibold text-[#475569] hover:text-[#1E293B]">Cancel</a>
                <button class="bg-[#0052CC] text-white text-sm font-bold px-5 py-2 rounded-lg shadow-md shadow-[#0052CC]/20 flex items-center gap-2 hover:bg-[#0042a3] transition">
