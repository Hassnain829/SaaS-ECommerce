                        ...
                        @if ($canManageShipping)
                            <td class="px-5 py-4 text-right">
                                <div class="flex flex-wrap justify-end gap-2">
                                    ...
                                    <form method="POST" action="{{ route('settings.shipping.zones.destroy', $zone) }}" data-ui-confirm="Remove this delivery area and its checkout options?" data-ui-confirm-title="Remove this delivery area?" data-ui-confirm-action="Remove area">
                                        @csrf @method('DELETE')
