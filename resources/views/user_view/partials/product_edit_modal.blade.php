            ...
            <form id="editProductForm" method="POST" enctype="multipart/form-data" class="space-y-6" @if ($editFormAction) action="{{ $editFormAction }}" @endif data-product-store-url="{{ route('product.store') }}" data-product-update-url-template="{{ route('product.update', ['productId' => '__PRODUCT_ID__']) }}">
                ...
                <div class="{{ $editSectionClass }}" @if ($productEditSurface === 'page' && $productEditPageNative) id="catalog-edit-section-basics" @endif>
                    <div @class(['mb-6 border-b border-slate-100 pb-4' => $productEditSurface === 'page' && $productEditPageNative, 'mb-6' => ! ($productEditSurface === 'page' && $productEditPageNative)])>
                        <h3 class="text-lg font-semibold text-[#0F172A] sm:text-xl">{{ ($productEditSurface === 'page' && $productEditPageNative) ? 'Product details' : 'Product details' }}</h3>
                        @if ($productEditSurface === 'page' && $productEditPageNative)
                    ...
                    @if ($productEditSurface === 'page' && $productEditPageNative)
                        <div id="catalog-edit-section-media" class="mt-6 scroll-mt-28">
                            <p class="text-xs font-bold uppercase tracking-wide text-[#94A3B8]">Media</p>
                    ...
                    @if ($productEditSurface === 'page' && $productEditPageNative)
                        <div class="mt-8 scroll-mt-28 border-t border-slate-100 pt-6">
                            <p class="text-xs font-bold uppercase tracking-wide text-[#94A3B8]">Price &amp; inventory</p>
                            <p class="mt-1 text-sm text-[#64748B]">Set the selling price and how many units you have. For products with size/color options, stock is set on each option below.</p>
                        </div>
                    @endif
                    <div id="catalog-edit-section-pricing" @class(['mt-4 scroll-mt-28 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4' => $productEditSurface === 'page' && $productEditPageNative, 'mt-6 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4' => ! ($productEditSurface === 'page' && $productEditPageNative)])>
                        ...
                        <div id="editMultiStockHint" class="hidden rounded-lg border border-[#D8E8E1] bg-[#F4FBF8] px-4 py-3">
                            ...
                            <p class="mt-1 text-xs text-[#64748B]">Scroll to <span class="font-medium">Options &amp; inventory</span> and enter quantity on each row.</p>
                        </div>
                ...
                <div class="{{ $editSectionClass }}" @if ($productEditSurface === 'page' && $productEditPageNative) id="catalog-edit-section-option-groups" @endif>
                    <div class="mb-6 flex items-center justify-between gap-3">
                        <div>
                            <h3 class="text-lg font-semibold text-[#0F172A] sm:text-xl scroll-mt-28">{{ ($productEditSurface === 'page' && $productEditPageNative) ? 'Options & inventory' : 'Option groups' }}</h3>
