      ...
      <div class="w-full max-w-[448px]">
        ...
        <form class="space-y-5" method="POST" action="{{ route('register.store') }}">
          ...
          <label class="flex items-start gap-3 pt-1">
            ...
            <span class="text-sm leading-5 text-[#64748B]">By creating an account, you agree to our <a href="{{ route('legal.terms') }}" class="font-semibold text-[#0052CC]">Terms of Service</a> and <a href="{{ route('legal.privacy') }}" class="font-semibold text-[#0052CC]">Privacy Policy</a>.</span>
          </label>
