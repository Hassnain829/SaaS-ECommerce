    ...
    <div class="flex-1 flex flex-col md:flex-row">
        <div class="w-full md:w-1/2 bg-white px-6 py-8 md:px-12 lg:px-16 xl:px-20 flex flex-col justify-center items-center">
            <div class="w-full max-w-[448px]">
                ...
                <form class="space-y-6" method="GET" action="{{ route('dashboard') }}">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" value="name@company.com" class="w-full pl-11 pr-4 py-3.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl text-sm text-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#0052CC]/20 focus:border-[#0052CC] transition">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" value="********" class="w-full pl-11 pr-4 py-3.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl text-sm text-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#0052CC]/20 focus:border-[#0052CC] transition">
                        </div>
                    </div>

                    <div class="flex items-center gap-2">
                        <input type="checkbox" id="keep-signed" class="w-4 h-4 rounded border-[#CBD5E1] text-[#0052CC] focus:ring-[#0052CC]">
