...
@section('title', 'Checkout shipping — '.config('app.name'))

@section('topbar')
    <x-ui.merchant-topbar title="Checkout shipping" lead="Choose FedEx live rates, fixed or free options, and what customers see at checkout.">
        <x-slot:actions>
...
@section('content')
    <div class="settings-workspace max-w-[720px] space-y-6">
