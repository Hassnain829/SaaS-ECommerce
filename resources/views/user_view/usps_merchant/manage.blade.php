...
@section('title', 'Manage USPS — '.config('app.name'))

@section('topbar')
    <x-ui.merchant-topbar title="Manage USPS connection" lead="Review merchant authorization and USPS account readiness.">
        <x-slot:actions>
