...
@section('content')
    <div class="mx-auto w-full max-w-[1440px]">
        <div class="mb-5 flex flex-wrap items-center gap-2 text-sm text-[#64748B]">
            ...
            <span>&gt;</span>
            <span class="font-inter font-medium text-[#0F172A]">Shipping &amp; Courier Automation</span>
        </div>

        <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
                <h1 class="text-3xl md:text-4xl font-poppins text-[#0F172A]">Shipping Automation Settings</h1>
            ...
            <div class="flex items-center gap-3">
                <button class="h-12 rounded-xl border border-[#D1D9E6] bg-white px-6 text-lg font-inter font-medium text-[#1E293B]">Export Logs</button>
                <button class="h-12 rounded-xl bg-[#0052CC] px-6 text-lg font-inter font-medium text-white">Save Changes</button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_390px]">
            <div class="space-y-6">
                <section class="rounded-2xl border border-[#D8E1EC] bg-white p-5 md:p-6">
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-poppins leading-tight text-[#0F172A]">Global Automation</h2>
                ...
                <section class="overflow-hidden rounded-2xl border border-[#D8E1EC] bg-white">
                    <div class="flex h-16 items-center justify-between border-b border-[#E2E8F0] px-5 md:px-6">
                        <h2 class="text-2xl font-poppins leading-tight text-[#0F172A]">Integrated Courier Services</h2>
                        <button class="text-base font-inter font-medium text-[#0052CC]">+ Add Carrier</button>
                    </div>
                ...
                <section class="rounded-2xl border border-[#D8E1EC] bg-white p-5 md:p-6">
                    <div class="mb-4 flex items-center justify-between">
                        ...
                        <span class="rounded-md bg-[#F1F5F9] px-2 py-1 text-xs font-inter font-medium text-[#94A3B8]">AI-Driven</span>
                    </div>
                    <div class="space-y-4">
            ...
            <aside class="space-y-6">
                <section class="rounded-2xl border border-[#D8E1EC] bg-white p-5 md:p-6">
                    <h2 class="mb-4 text-2xl font-poppins leading-tight">Regional Preferences</h2>
                    ...
                    <div class="rounded-xl border border-[#BFDBFE] bg-[#EFF6FF] p-4">
                        ...
                        <label class="mt-3 block"><span class="mb-1.5 block text-base font-inter font-medium text-[#737373]">Store Currency</span><select class="h-11 w-full rounded-xl border border-[#CBD5E1] bg-[#F8FAFC] px-3 text-[#94A3B8]"><option>USD - United States Dollar ($)</option></select></label>
                        <label class="mt-3 block"><span class="mb-1.5 block text-base font-inter font-medium text-[#737373]">Time Zone</span><select class="h-11 w-full rounded-xl border border-[#CBD5E1] bg-[#F8FAFC] px-3 text-[#94A3B8]"><option>(UTC-08:00) Pacific Time (US)</option></select></label>
                    </div>
                </section>

                <section class="rounded-2xl border border-[#D8E1EC] bg-white p-5 md:p-6">
                    <h2 class="mb-4 text-2xl font-poppins leading-tight">Automation Insights</h2>
                    <div class="space-y-4">
                ...
                <section class="rounded-2xl border border-[#D8E1EC] bg-white p-5 md:p-6">
                    <h2 class="mb-4 text-2xl font-poppins leading-tight text-[#0F172A]">Notification Preferences</h2>
                    <div class="space-y-4">
