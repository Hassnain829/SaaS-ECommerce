...
<head>
    ...
    <title>Onboarding - Store Details | {{ config('app.name') }}</title>
...
<body class="user-typography bg-[#F5F7F8] antialiased text-[#0F172A] min-h-screen flex flex-col overflow-x-hidden">
        ...
        <header class="flex justify-between items-center px-4 sm:px-6 lg:px-16 py-3 bg-white border-b border-[#E2E8F0] w-full">
            ...
            <div class="flex items-center gap-3 sm:gap-6">
                ...
                <div class="flex items-center gap-3 sm:gap-4">
                    <button form="store-onboarding-form" type="submit" class="hidden sm:inline-flex bg-brand text-white text-sm font-bold px-4 py-2 rounded-lg shadow-sm">Save & Continue</button>
        ...
        <main class="w-full max-w-5xl mx-auto px-6 py-8 sm:px-10">
            ...
            <div class="mb-8">
                ...
                <div class="w-full h-2 bg-[#E2E8F0] rounded-full overflow-hidden">
                    <div class="w-1/3 h-2 bg-brand rounded-full"></div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-[#E2E8F0] p-6 md:p-8">
                ...
                <form id="store-onboarding-form" action="{{ route('onboarding-StoreDetails-1.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="name" class="block text-sm font-medium text-[#334155] mb-2">Store Name</label>
                        ...
                        <div>
                            <label for="primary_market" class="block text-sm font-medium text-[#334155] mb-2">Primary market</label>
                            <div class="relative">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-[#334155] mb-2">Store Logo</label>
                        <div class="bg-[#F8FAFC] border-2 border-dashed border-[#CBD5E1] rounded-xl p-8 flex flex-col items-center gap-4">
                            ...
                            <label for="store_logo" class="inline-flex h-9 items-center justify-center whitespace-nowrap bg-brand px-4 text-xs font-bold text-white rounded-lg shadow-md hover:bg-brand-hover transition cursor-pointer">Browse Files</label>
                            <input id="store_logo" name="store_logo" type="file" accept=".jpg,.jpeg,.png,.svg" class="hidden">
                        </div>
                    </div>

                    <div>
                        <label for="address" class="block text-sm font-medium text-[#334155] mb-2">Business Address</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="currency" class="block text-sm font-medium text-[#334155] mb-2">Default store currency</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="timezone" class="block text-sm font-medium text-[#334155] mb-2">Default store timezone</label>
                            <div class="relative">
                    ...
                    <div class="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-5">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                            <div class="category-tile bg-brand/5 border-2 border-[#0052CC] rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer" data-category="physical" data-model="Physical Goods">
                                ...
                                <span class="text-xs text-center text-[#0F172A]">Physical Goods</span>
                            </div>
                            <div class="category-tile bg-white border border-[#E2E8F0] rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer" data-category="digital" data-model="Digital Products">
                                ...
                                <span class="text-xs text-center text-[#0F172A]">Digital Products</span>
                            </div>
                            <div class="category-tile bg-white border border-[#E2E8F0] rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer" data-category="service" data-model="Services">
                                ...
                                <span class="text-xs text-center text-[#0F172A]">Services</span>
                            </div>
                            <div class="category-tile bg-white border border-[#E2E8F0] rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer" data-category="subscription" data-model="Subscriptions">
                                ...
                                <span class="text-xs text-center text-[#0F172A]">Subscriptions</span>
                            </div>
                            <div class="category-tile bg-white border border-[#E2E8F0] rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer" data-category="virtual" data-model="Memberships">
                                ...
                                <span class="text-xs text-center text-[#0F172A]">Memberships</span>
                            </div>
                            <button id="openCustomCategoryModal" type="button" class="bg-white border-2 border-dashed border-[#CBD5E1] rounded-xl p-4 flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-[#94A3B8] transition w-full">
                                ...
                                <span class="text-xs text-center text-[#475569]">Other / Custom</span>
                            </button>
                        </div>
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-[#E2E8F0]">
                        ...
                        <button type="submit" class="inline-flex h-12 items-center justify-center whitespace-nowrap bg-brand text-white font-bold px-6 rounded-lg shadow-lg shadow-brand/20 hover:bg-brand-hover transition gap-2 min-w-[144px]">
    ...
    <div class="text-center text-xs text-[#94A3B8] py-4">&copy; {{ config('app.name') }} &middot; Onboarding</div>
    <script>
        (() => {
            ...
            if (categoryInput.value) {
                ...
                tiles.forEach((tile) => {
                    tile.classList.remove('bg-brand/5', 'border-2', 'border-[#0052CC]');
