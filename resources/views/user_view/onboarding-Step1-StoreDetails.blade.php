            ...
            <div class="bg-white rounded-xl shadow-sm border border-[#E2E8F0] p-6 md:p-8">
                ...
                <div class="space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-[#334155] mb-2 font-[Poppins]">Store Name</label>
                            <input type="text" placeholder="e.g. Modern Marketplace" value="Modern Marketplace"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-[#334155] mb-2 font-[Poppins]">Primary Market</label>
                            <div class="relative">
                                <select class="w-full appearance-none px-4 py-3 border border-[#CBD5E1] rounded-lg text-sm text-[#0F172A] bg-white focus:outline-none focus:ring-2 focus:ring-[#0052CC]/20">
                                    <option selected>Global Market</option>
                    ...
                    <div>
                        ...
                        <div class="bg-[#F8FAFC] border-2 border-dashed border-[#CBD5E1] rounded-xl p-8 flex flex-col items-center gap-4">
                            ...
                            <button class="inline-flex h-9 items-center justify-center whitespace-nowrap bg-[#0052CC] px-4 text-xs font-bold text-white rounded-lg shadow-md hover:bg-[#0042a3] transition">Browse Files</button>
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-[#334155] mb-2 font-[Poppins]">Business Address</label>
                        <textarea rows="3" placeholder="Street address, City, State, Zip Code" class="w-full px-4 py-3 border border-[#CBD5E1] rounded-lg text-sm text-[#0F172A] placeholder:text-[#6B7280] focus:outline-none focus:ring-2 focus:ring-[#0052CC]/20"></textarea>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-[#334155] mb-2 font-[Poppins]">Store Currency</label>
                            <div class="relative">
                                <select class="w-full appearance-none px-4 py-3 border border-[#CBD5E1] rounded-lg text-sm text-[#0F172A] bg-white">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-[#334155] mb-2 font-[Poppins]">Timezone</label>
                            <div class="relative">
                                <select class="w-full appearance-none px-4 py-3 border border-[#CBD5E1] rounded-lg text-sm text-[#0F172A] bg-white">
                                    <option selected>UTC+0 (London, Dublin)</option>
                    ...
                    <div class="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-5">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                            <div class="bg-[#0052CC]/5 border-2 border-[#0052CC] rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer">
                            ...
                            <div class="bg-white border border-[#E2E8F0] rounded-xl p-4 flex flex-col items-center gap-2 cursor-pointer">
                            ...
                            <a href="{{ route('AddCustomCategoryOverlay') }}" class="bg-white border-2 border-dashed border-[#CBD5E1] rounded-xl p-4 flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-[#94A3B8] transition">
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-[#E2E8F0]">
                        <button class="text-sm font-semibold text-[#64748B] hover:text-[#334155] transition">Skip for now</button>
                        <button class="inline-flex h-12 items-center justify-center whitespace-nowrap bg-[#0052CC] text-white font-bold px-6 rounded-lg shadow-lg shadow-[#0052CC]/20 hover:bg-[#0042a3] transition gap-2 min-w-[144px]">
