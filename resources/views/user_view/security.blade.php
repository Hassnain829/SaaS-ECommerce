...
@php
  $eventLabels = [
    ...
    'api_key_created' => 'Website connection key created',
    'api_key_revoked' => 'Website connection key removed',
    'connected_site.auth_failed' => 'Website connection attempt failed',
