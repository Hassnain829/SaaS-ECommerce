        ...
        <div class="mx-auto max-w-5xl">
            ...
            <form method="post" action="{{ route('products.import.mapping.save', ['productImportId' => $import->id]) }}" class="rounded-3xl border border-[#E2E8F0] bg-white p-6 shadow-sm sm:p-8">
                ...
                <div class="mb-8 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] px-4 py-3 text-sm text-[#475569]">
                    ...
                    <p class="mt-1">We may have pre-selected matches from your header row—confirm them below. Map each spreadsheet column to one catalog target. <span class="font-medium text-[#334155]">Product specifications</span> are reusable product facts shoppers can filter or compare, such as material, capacity, color family, ingredients, or compatibility. <span class="font-medium text-[#334155]">Additional details</span> are editable extra product information your team wants to track, such as supplier, material, origin, care notes, warranty, or internal references. Unmapped columns will be preserved as <span class="font-medium text-[#334155]">Advanced imported data</span> so nothing from your spreadsheet is lost.</p>
                            ...
                            <div class="custom-field-row grid gap-2 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4 sm:grid-cols-[1fr_1fr_140px_auto] sm:items-end">
                                ...
                                <div>
                                    ...
                                    <select name="custom_field_mappings[{{ $i }}][scope]" class="mt-1 w-full rounded-xl border border-[#CBD5E1] bg-white px-3 py-2 text-sm text-[#0F172A]">
                                        ...
                                        <option value="attribute" @selected($scopeVal === 'attribute')>Product specification</option>
                                    </select>
                                </div>
                    ...
                    <div class="custom-field-row grid gap-2 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4 sm:grid-cols-[1fr_1fr_140px_auto] sm:items-end">
                        ...
                        <div>
                            ...
                            <select data-name-scope class="mt-1 w-full rounded-xl border border-[#CBD5E1] bg-white px-3 py-2 text-sm text-[#0F172A]">
                                ...
                                <option value="attribute">Product specification</option>
                            </select>
                        </div>
                        <div class="flex sm:justify-end">
                            <button type="button" class="remove-custom-field text-sm font-semibold text-[#B42318] hover:underline">Remove</button>
