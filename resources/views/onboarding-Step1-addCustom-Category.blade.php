        ...
        <div class="w-full max-w-4xl overflow-hidden rounded-2xl border border-[#E2E8F0] bg-white shadow-2xl">
            <div class="border-b border-[#F1F5F9] px-6 pb-4 pt-6">
                <div class="flex items-start justify-between gap-4">
                    ...
                    <a href="{{ route('onboarding-StoreDetails-1') }}" class="text-[#94A3B8] transition hover:text-[#64748B]" aria-label="Close overlay">
            ...
            <div class="max-h-[36rem] space-y-8 overflow-y-auto px-6 py-4 md:max-h-[60vh]">
                <section>
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Fashion</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">Clothing &amp; Shoes</div>
                            </div>
                        </div>
                        ...
                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Electronics</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">Tech &amp; Gadgets</div>
                            </div>
                        </div>

                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            <span class="absolute right-3 top-3 inline-flex h-4 w-4 items-center justify-center rounded-full bg-[#0052CC] text-[10px] font-bold leading-none text-white">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Home</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">Furniture &amp; Decor</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Subscriptions</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">SaaS &amp; Content</div>
                            </div>
                        </div>
                        ...
                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Virtual Products</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">Assets &amp; Files</div>
                            </div>
                        </div>
                        ...
                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Consultations</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">Services &amp; Advice</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Health &amp; Wellness</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">Supplements &amp; Gear</div>
                            </div>
                        </div>
                        ...
                        <div class="relative flex min-h-[70px] items-start gap-3 rounded-xl bg-[#F8FAFC] px-4 py-3.5">
                            ...
                            <div>
                                <div class="text-[15px] font-semibold leading-[1.25] text-[#4A84DA]">Toys &amp; Games</div>
                                <div class="mt-1 text-[13px] leading-[1.35] text-[#94A3B8]">Entertainment</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="rounded-[14px] bg-[#F8FAFC] px-6 py-5">
                    ...
                    <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center lg:justify-end">
                        ...
                        >
                        <button class="inline-flex h-12 min-w-20 items-center justify-center whitespace-nowrap rounded-xl bg-[#0052CC] px-[18px] text-sm font-bold leading-none text-white shadow-lg shadow-[#0052CC]/20 transition hover:bg-[#0042A3]">
                            + Add
                        </button>
                    </div>
                    </div>
            ...
            <div class="border-t border-[#F1F5F9] bg-[#F8FAFC] px-6 py-4">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <a href="{{ route('onboarding-StoreDetails-1') }}" class="text-sm font-medium text-[#94A3B8] transition hover:text-[#64748B]">Cancel and close</a>
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-[22px]">
                        <span class="text-sm text-[#94A3B8]">1 category selected</span>
                        <button class="inline-flex h-[46px] min-w-[170px] items-center justify-center whitespace-nowrap rounded-xl bg-[#0052CC] px-6 text-sm font-bold text-white shadow-lg shadow-[#0052CC]/20 transition hover:bg-[#0042A3]">
                            Confirm Selection
                        </button>
                    </div>
                </div>
