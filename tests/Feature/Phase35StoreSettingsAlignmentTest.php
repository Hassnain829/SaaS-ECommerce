...
class Phase35StoreSettingsAlignmentTest extends TestCase
{
    ...
    public function test_store_settings_and_onboarding_copy_separate_locations_markets_currency_and_timezone(): void
    {
        ...
        $this->actingAs($owner)
            ...
            ->assertSee('Base currency for future dashboard totals and default pricing.', false)
            ->assertSee('Default Store Timezone', false)
            ->assertSee('Used for future dashboard dates and store operations.', false)
            ->assertSee('Primary Market', false)
            ->assertSee('Default selling region for this store. Manage via region settings.', false)
            ->assertSee('Edit profile', false)
            ->assertSee('Edit settings', false)
            ->assertSee('Configure', false)
