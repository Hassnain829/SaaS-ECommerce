...
class Phase35StoreSettingsAlignmentTest extends TestCase
{
    ...
    public function test_store_settings_and_onboarding_copy_separate_locations_markets_currency_and_timezone(): void
    {
        ...
        $this->actingAs($owner)
            ...
            ->assertSee('Base currency for future dashboard totals and default pricing. Historical orders keep their saved currency and totals.', false)
            ->assertSee('Default store timezone', false)
            ->assertSee('Used for future dashboard dates and store operations. Past order timestamps stay unchanged.', false)
            ->assertSee('Primary market', false)
            ->assertSee('Default selling region for this store. Change it from the store editor when you have permission.', false)
            ...
            ->assertDontSee('Read-only fact', false);
