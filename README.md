...
- **[docs/plans/PHASE_5R_1_TAX_FOUNDATION_IMPLEMENTATION_PLAN.md](docs/plans/PHASE_5R_1_TAX_FOUNDATION_IMPLEMENTATION_PLAN.md)** — tax foundation plan (5R-1; Slices 1A–2 implemented; checkout wiring pending).
