...
$testKey = env('STRIPE_TEST_KEY', $legacyMode === 'test' ? $legacyKey : null);
$testSecret = env('STRIPE_TEST_SECRET', $legacyMode === 'test' ? $legacySecret : null);
...
$liveKey = env('STRIPE_LIVE_KEY', $legacyMode === 'live' ? $legacyKey : null);
$liveSecret = env('STRIPE_LIVE_SECRET', $legacyMode === 'live' ? $legacySecret : null);
