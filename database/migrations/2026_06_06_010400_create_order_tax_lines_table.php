...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('order_tax_lines', function (Blueprint $table): void {
            ...
            $table->index(['store_id', 'order_id'], 'order_tax_lines_store_order_index');
            $table->index(['order_id', 'applies_to'], 'order_tax_lines_order_applies_index');
            $table->index('tax_rate_id', 'order_tax_lines_tax_rate_index');
        });
    }
